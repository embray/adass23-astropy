...
%\texttt{astropy.units} & Active & \\
%\texttt{astropy.constants} & Active &
%Contains a number of physical constants useful in astronomy and physics.
%Constants are representing as \texttt{Quantity} objects with additional
%meta-data describing their provenance and uncertainties.\\

% - Robust. sustainable infrastructure
%   - Data structure integration
%   - Coding style
%   - Documentation
%   - Tests (several thousand)
%   - Continuous integration on Linux, OSX, and Windows
%     - Tests against multiple versions of Python and Numpy
% 
% - Ease of installation
%   - Relatively few dependencies
%   - Build and test infrastructure
%   - Quality build system for ease of inclusion in software bundles like
%     Enthought Canopy and Continuum Analytics Anaconda, as well as OS
%     packages like Debian/Ubuntu
% 
% - Ease of reuse
%   - Nonrestricive licence
%   - Even includes ERFA--a fork of SOFA with a less restrictive license
% 
% - Core sub-packages
% 
% - Affiliated packages
%   - Allow for different solutions to common needs
%   - Express an interest in the goal of improving ruse, interoperability,
%     and coding standards
%   - Leverage the Astropy docs / installation / testing interface
%   - Hosted either under the Astropy project or independently
%   - Where appropriate can track for inclusion in the core `astropy` package
%   - Packages
%     - Featured
%       - Montage-wrapper // Python wrapper for the Montage Astronomical Image
%         Mosaic Engine
%       - Ginga // Graphical application for viewing and plotting on
%         astronomical images from FITS files
%       - APLpy - Graphical application and library aimed at producing
%         publication-quality plots of astronomical data from FITS files
%     - Others
%       - astroML
%       - astropysics
%       - astroquery
...
%   - Statistics:
%     - 51+ contributors on GitHub
%     - 21+ with > 10 commits; 9 with > 100 commits
%     - 191+ people on astropy-dev
%   - Social media
%   - GSoC
% 
% - Technologies
